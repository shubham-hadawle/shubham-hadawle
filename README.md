...
## About Me 🚀
Hi, I'm Shubham Hadawle, a Computer Science Master’s student at Northeastern University with a specialized focus on Software Engineering, Artificial Intelligence and Machine Learning. My technical foundation is built on a Bachelor’s degree in AI and Data Science, complemented by a diverse toolkit including Python, Java, PyTorch, and TensorFlow. I have a proven track record of developing sophisticated AI solutions, ranging from GraphRAG-enhanced LLMs at Axis Bank to high-performance deep neural networks for nuclear reactor simulation at the Bhabha Atomic Research Centre (BARC). My passion lies in bridging the gap between complex research and scalable production, as evidenced by my published work in Springer Journals regarding time-series anomaly detection and multilingual text summarization.

Beyond my professional internships, I am an active creator and researcher dedicated to open-source and community-driven technology. I have engineered and published a cross-platform game with over 1,000 downloads on the Google Play Store and developed end-to-end NLP pipelines for automated education tools. Recognized as a Dean's Merit Scholar and a multi-time hackathon finalist, I thrive in fast-paced environments where I can apply MLOps, computer vision, and generative AI to solve real-world challenges. My technical skills include Python, Java, C++, AWS, Microsoft Azure, and expertise in data pipelines, database management, and cloud computing. Driven by curiosity and a passion for innovation, I am always eager to collaborate, explore new technologies, and push the boundaries of AI-driven solutions.
